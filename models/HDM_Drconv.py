...
from models.drconv import DRConv2d,DRConv2d_phy
...
class DR_Net_phy(torch.nn.Module):
    ...
    def forward(self, x,mask):
        ...
        x_dcn1_img = self.drconv(temp1)

        x_dcn1_dcp = self.drconv_phy(temp1,mask)

        x_dcn1 = self.mix3(x_dcn1_img,x_dcn1_dcp)
        x_dcn2 = self.dcn_block(x_dcn1)

        temp2 = x_dcn2
        x_dcn2_img = self.drconv(temp2)
        x_dcn2_phy = self.drconv_phy(temp2, mask)
        x_dcn2 = self.mix4(x_dcn2_img,x_dcn2_phy)
